 ...
 */
class SubjectIdRetrievingException extends SubjectManipulatorException implements WorkflowExceptionInterface
{
    /**
     ...
     * @return static
     */
    public static function expressionNotFound($subjectClass)
    {
     ...
     * @return static
     */
    public static function subjectIsNotAnObject($subject)
    {
